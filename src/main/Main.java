...
class Main {
	public static void main(String[] args) {
		...
		workerQueue.addWorker(new Counter("lock_objects_extends", Scope.CLASS, "EXTENDS_CLAUSE", "TYPE", "QUALIFIED_TYPE_IDENT", "Lock"));
		...
		workerQueue.addWorker(new Counter("blockingQueue_objects_extends", Scope.CLASS, "EXTENDS_CLAUSE", "TYPE", "QUALIFIED_TYPE_IDENT", "BlockingQueue"));
		...
		workerQueue.addWorker(new Counter("deleyQueue_objects_extends", Scope.CLASS, "EXTENDS_CLAUSE", "TYPE", "QUALIFIED_TYPE_IDENT", "DeleyQueue"));
