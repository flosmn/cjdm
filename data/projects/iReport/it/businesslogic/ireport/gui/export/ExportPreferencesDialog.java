...
public class ExportPreferencesDialog extends javax.swing.JDialog {
    ...
    public ExportPreferencesDialog(java.awt.Frame parent, boolean modal) {
        ...
        categorySheetPanel.addSheetProperty("Text Exporter", new SheetProperty("TXT_DISPLAY_WIDTH_PROVIDER_FACTORY","Display Width Provider Factory calss", SheetProperty.STRING));
        defaultValues.setProperty("TXT_DISPLAY_WIDTH_PROVIDER_FACTORY", "");
