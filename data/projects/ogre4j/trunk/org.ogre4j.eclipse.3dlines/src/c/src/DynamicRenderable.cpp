...
{
#ifdef _DEBUG
	std::cout << "DynamicRenderable::DynamicRenderable()" << std::endl;
#endif
}
...
{
#ifdef _DEBUG
	std::cout << "DynamicRenderable::initialize" << std::endl;
#endif
...
{
#ifdef _DEBUG
	std::cout << "DynamicRenderable::prepareHardwareBuffers" << std::endl;
#endif
...
{
#ifdef _DEBUG
	std::cout << "DynamicRenderable::getBoundingRadius" << std::endl;
#endif
...
{
#ifdef _DEBUG
	std::cout << "DynamicRenderable::getSquaredViewDepth" << std::endl;
#endif
