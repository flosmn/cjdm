...
public class Rectangle extends org.xbig.base.NativeObject implements org.ogre4j.IRectangle {
static { System.loadLibrary("ogre4j");}
	 ...
	 * 
	 */
	public Rectangle(org.xbig.base.InstancePointer p) {
		super(p);
	}
	 ...
	 * 
	 */
	protected Rectangle(org.xbig.base.InstancePointer p, boolean remote) {
		super(p, remote);
	}
     ...
     */
	public Rectangle(org.xbig.base.WithoutNativeObject val) {
		super(val);
	}
    ...
    public boolean inside(float x, float y) {
         return _inside__RealvRealv_const(this.object.pointer, x,  y);
    }

    private native boolean _inside__RealvRealv_const(long _pointer_, float x, float y);

    /** **/
    public Rectangle() {
         super( new org.xbig.base.InstancePointer(__createRectangle()), false);
    }

    private native static long __createRectangle();
