...
public class FreeImageCodec extends org.xbig.base.NativeObject implements org.ogre4j.IFreeImageCodec {
static { System.loadLibrary("ogre4j");}
private static class RegisteredCodecList extends org.xbig.base.NativeObject implements org.ogre4j.IFreeImageCodec.IRegisteredCodecList {
static { System.loadLibrary("ogre4j");}
	 ...
	 * 
	 */
	public RegisteredCodecList(org.xbig.base.InstancePointer p) {
		super(p);
	}
	 ...
	 * 
	 */
	protected RegisteredCodecList(org.xbig.base.InstancePointer p, boolean remote) {
		super(p, remote);
	}
     ...
     */
	public RegisteredCodecList(org.xbig.base.WithoutNativeObject val) {
		super(val);
	}
	...
	private final native void __delete(long _pointer_);	
          ...
          /** **/
    public RegisteredCodecList() {
         super( new org.xbig.base.InstancePointer(__createRegisteredCodecList()), false);
    }

    private native static long __createRegisteredCodecList();

    /** **/
    public void assign(int num, org.ogre4j.IImageCodec val) {
        _assign__ivOgre_ImageCodecP(this.object.pointer, num,  val.getInstancePointer().pointer);
    }

    private native void _assign__ivOgre_ImageCodecP(long _pointer_, int num, long val);

    /** **/
    public org.ogre4j.IImageCodec back() {
         return new org.ogre4j.ImageCodec(new InstancePointer(_back(this.object.pointer)));
    }
    ...
    public org.ogre4j.IImageCodec front() {
         return new org.ogre4j.ImageCodec(new InstancePointer(_front(this.object.pointer)));
    }
    ...
    public void push_back(org.ogre4j.IImageCodec val) {
        _push_back__Ogre_ImageCodecP(this.object.pointer, val.getInstancePointer().pointer);
    }

    private native void _push_back__Ogre_ImageCodecP(long _pointer_, long val);

    /** **/
    public void push_front(org.ogre4j.IImageCodec val) {
        _push_front__Ogre_ImageCodecP(this.object.pointer, val.getInstancePointer().pointer);
    }

    private native void _push_front__Ogre_ImageCodecP(long _pointer_, long val);

    /** **/
    public void remove(org.ogre4j.IImageCodec val) {
        _remove__Ogre_ImageCodecP(this.object.pointer, val.getInstancePointer().pointer);
    }

    private native void _remove__Ogre_ImageCodecP(long _pointer_, long val);
	 ...
	 * 
	 */
	public FreeImageCodec(org.xbig.base.InstancePointer p) {
		super(p);
	}
	 ...
	 * 
	 */
	protected FreeImageCodec(org.xbig.base.InstancePointer p, boolean remote) {
		super(p, remote);
	}
     ...
     * @see org.xbig.base.INativeObject#disconnectFromNativeObject()
     */
	public FreeImageCodec(org.xbig.base.WithoutNativeObject val) {
		super(val);
	}
    ...
    public FreeImageCodec(String type, long fiType) {
         super( new org.xbig.base.InstancePointer(__createFreeImageCodec__StringRIv( type,  fiType)), false);
    }

    private native static long __createFreeImageCodec__StringRIv(String type, long fiType);
