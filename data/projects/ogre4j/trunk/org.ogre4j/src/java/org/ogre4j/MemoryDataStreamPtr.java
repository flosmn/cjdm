...
public class MemoryDataStreamPtr extends org.xbig.base.NativeObject implements org.ogre4j.IMemoryDataStreamPtr {
static { System.loadLibrary("ogre4j");}
	 ...
	 * 
	 */
	public MemoryDataStreamPtr(org.xbig.base.InstancePointer p) {
		super(p);
	}
	 ...
	 * 
	 */
	protected MemoryDataStreamPtr(org.xbig.base.InstancePointer p, boolean remote) {
		super(p, remote);
	}
     ...
     */
	public MemoryDataStreamPtr(org.xbig.base.WithoutNativeObject val) {
		super(val);
	}
    ...
    public MemoryDataStreamPtr() {
         super( new org.xbig.base.InstancePointer(__createMemoryDataStreamPtr()), false);
    }

    private native static long __createMemoryDataStreamPtr();

    /** **/
    public org.ogre4j.IMemoryDataStreamPtr operatorAssignment(org.ogre4j.IMemoryDataStreamPtr r) {
         return new org.ogre4j.MemoryDataStreamPtr(new InstancePointer(_operatorAssignment___Ogre_SharedPtrR(this.object.pointer, r.getInstancePointer().pointer)));
    }
    ...
    public org.ogre4j.IMemoryDataStream operatorMultiplication() {
         return new org.ogre4j.MemoryDataStream(new InstancePointer(_operatorMultiplication_const(this.object.pointer)));
    }
    ...
    public org.ogre4j.IMemoryDataStream operatorMemberAccessFromAPointer() {
         return new org.ogre4j.MemoryDataStream(new InstancePointer(_operatorMemberAccessFromAPointer_const(this.object.pointer)));
    }
    ...
    public org.ogre4j.IMemoryDataStream get() {
         return new org.ogre4j.MemoryDataStream(new InstancePointer(_get_const(this.object.pointer)));
    }
    ...
    public void bind(org.ogre4j.IMemoryDataStream rep, org.ogre4j.SharedPtrFreeMethod freeMethod) {
        _bind__Ogre_MemoryDataStreamp_Ogre_SharedPtrFreeMethodv(this.object.pointer, rep.getInstancePointer().pointer,  freeMethod.getValue());
    }

    private native void _bind__Ogre_MemoryDataStreamp_Ogre_SharedPtrFreeMethodv(long _pointer_, long rep, int freeMethod);
    ...
    public org.ogre4j.IMemoryDataStream getPointer() {
         return new org.ogre4j.MemoryDataStream(new InstancePointer(_getPointer_const(this.object.pointer)));
    }
