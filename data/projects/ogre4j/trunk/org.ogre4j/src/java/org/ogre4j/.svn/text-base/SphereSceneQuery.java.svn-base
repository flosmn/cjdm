...
public class SphereSceneQuery extends org.xbig.base.NativeObject implements org.ogre4j.ISphereSceneQuery {
static { System.loadLibrary("ogre4j");}
	 ...
	 * 
	 */
	public SphereSceneQuery(org.xbig.base.InstancePointer p) {
		super(p);
	}
	 ...
	 * 
	 */
	protected SphereSceneQuery(org.xbig.base.InstancePointer p, boolean remote) {
		super(p, remote);
	}
     ...
     */
	public SphereSceneQuery(org.xbig.base.WithoutNativeObject val) {
		super(val);
	}
    ...
    public void setSphere(org.ogre4j.ISphere sphere) {
        _setSphere__SphereR(this.object.pointer, sphere.getInstancePointer().pointer);
    }

    private native void _setSphere__SphereR(long _pointer_, long sphere);

    /** 
    Gets the sphere which is being used for this query. **/
    public org.ogre4j.ISphere getSphere() {
         return new org.ogre4j.Sphere(new InstancePointer(_getSphere_const(this.object.pointer)));
    }

    private native long _getSphere_const(long _pointer_);
