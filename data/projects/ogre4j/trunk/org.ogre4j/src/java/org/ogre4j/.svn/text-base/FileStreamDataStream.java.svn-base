...
public class FileStreamDataStream extends org.xbig.base.NativeObject implements org.ogre4j.IFileStreamDataStream {
static { System.loadLibrary("ogre4j");}
	 ...
	 * 
	 */
	public FileStreamDataStream(org.xbig.base.InstancePointer p) {
		super(p);
	}
	 ...
	 * 
	 */
	protected FileStreamDataStream(org.xbig.base.InstancePointer p, boolean remote) {
		super(p, remote);
	}
     ...
     */
	public FileStreamDataStream(org.xbig.base.WithoutNativeObject val) {
		super(val);
	}
    ...
    public FileStreamDataStream(org.std.Iifstream s, boolean freeOnClose) {
         super( new org.xbig.base.InstancePointer(__createFileStreamDataStream__std_ifstreampbv( s.getInstancePointer().pointer,  freeOnClose)), false);
    }

    private native static long __createFileStreamDataStream__std_ifstreampbv(long s, boolean freeOnClose);

    /** 
    Construct named stream from an STL stream **/
    public FileStreamDataStream(String name, org.std.Iifstream s, boolean freeOnClose) {
         super( new org.xbig.base.InstancePointer(__createFileStreamDataStream__StringRstd_ifstreampbv( name,  s.getInstancePointer().pointer,  freeOnClose)), false);
    }

    private native static long __createFileStreamDataStream__StringRstd_ifstreampbv(String name, long s, boolean freeOnClose);

    /** 
    Construct named stream from an STL stream, and tell it the size **/
    public FileStreamDataStream(String name, org.std.Iifstream s, int size, boolean freeOnClose) {
         super( new org.xbig.base.InstancePointer(__createFileStreamDataStream__StringRstd_ifstreampivbv( name,  s.getInstancePointer().pointer,  size,  freeOnClose)), false);
    }

    private native static long __createFileStreamDataStream__StringRstd_ifstreampivbv(String name, long s, int size, boolean freeOnClose);
