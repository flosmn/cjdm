...
public class EntityFactory extends org.xbig.base.NativeObject implements org.ogre4j.IEntityFactory {
static { System.loadLibrary("ogre4j");}
	 ...
	 * 
	 */
	public EntityFactory(org.xbig.base.InstancePointer p) {
		super(p);
	}
	 ...
	 * 
	 */
	protected EntityFactory(org.xbig.base.InstancePointer p, boolean remote) {
		super(p, remote);
	}
     ...
     */
	public EntityFactory(org.xbig.base.WithoutNativeObject val) {
		super(val);
	}
    ...
    public EntityFactory() {
         super( new org.xbig.base.InstancePointer(__createEntityFactory()), false);
    }

    private native static long __createEntityFactory();
