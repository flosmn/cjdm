...
public class SkeletonManager extends org.xbig.base.NativeObject implements org.ogre4j.ISkeletonManager {
static { System.loadLibrary("ogre4j");}
	 ...
	 * 
	 */
	public SkeletonManager(org.xbig.base.InstancePointer p) {
		super(p);
	}
	 ...
	 * 
	 */
	protected SkeletonManager(org.xbig.base.InstancePointer p, boolean remote) {
		super(p, remote);
	}
     ...
     */
	public SkeletonManager(org.xbig.base.WithoutNativeObject val) {
		super(val);
	}
    ...
    public SkeletonManager() {
         super( new org.xbig.base.InstancePointer(__createSkeletonManager()), false);
    }

    private native static long __createSkeletonManager();

    /** 
    Override standard  retrieval. **/
    public static org.ogre4j.ISkeletonManager getSingleton() {
         return new org.ogre4j.SkeletonManager(new InstancePointer(_getSingleton()));
    }
    ...
    /** 
    Override standard  retrieval. **/
    public static org.ogre4j.ISkeletonManager getSingletonPtr() {
         return new org.ogre4j.SkeletonManager(new InstancePointer(_getSingletonPtr()));
    }
