...
public class PlaneBoundedVolumeListSceneQuery extends org.xbig.base.NativeObject implements org.ogre4j.IPlaneBoundedVolumeListSceneQuery {
static { System.loadLibrary("ogre4j");}
	 ...
	 * 
	 */
	public PlaneBoundedVolumeListSceneQuery(org.xbig.base.InstancePointer p) {
		super(p);
	}
	 ...
	 * 
	 */
	protected PlaneBoundedVolumeListSceneQuery(org.xbig.base.InstancePointer p, boolean remote) {
		super(p, remote);
	}
     ...
     */
	public PlaneBoundedVolumeListSceneQuery(org.xbig.base.WithoutNativeObject val) {
		super(val);
	}
    ...
    public void setVolumes(org.ogre4j.IPlaneBoundedVolumeList volumes) {
        _setVolumes__PlaneBoundedVolumeListR(this.object.pointer, volumes.getInstancePointer().pointer);
    }

    private native void _setVolumes__PlaneBoundedVolumeListR(long _pointer_, long volumes);

    /** 
    Gets the volume which is being used for this query. **/
    public org.ogre4j.IPlaneBoundedVolumeList getVolumes() {
         return new org.ogre4j.PlaneBoundedVolumeList(new InstancePointer(_getVolumes_const(this.object.pointer)));
    }

    private native long _getVolumes_const(long _pointer_);
