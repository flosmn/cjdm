...
public class ImportAbstractNode extends org.xbig.base.NativeObject implements org.ogre4j.IImportAbstractNode {
static { System.loadLibrary("ogre4j");}
	 ...
	 * 
	 */
	public ImportAbstractNode(org.xbig.base.InstancePointer p) {
		super(p);
	}
	 ...
	 * 
	 */
	protected ImportAbstractNode(org.xbig.base.InstancePointer p, boolean remote) {
		super(p, remote);
	}
     ...
     */
	public ImportAbstractNode(org.xbig.base.WithoutNativeObject val) {
		super(val);
	}
    ...
    public ImportAbstractNode() {
         super( new org.xbig.base.InstancePointer(__createImportAbstractNode()), false);
    }

    private native static long __createImportAbstractNode();
    ...
    public String gettarget() {
         return _gettarget(this.object.pointer);
    }

    private native String _gettarget(long _pointer_);

    /** **/
    public void settarget(String _jni_value_) {
        _settarget(this.object.pointer, _jni_value_);
    }

    private native void _settarget(long _pointer_, String _jni_value_);
