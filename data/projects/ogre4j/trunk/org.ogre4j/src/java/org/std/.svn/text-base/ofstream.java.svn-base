...
public class ofstream extends org.xbig.base.NativeObject implements org.std.Iofstream {
static { System.loadLibrary("ogre4j");}
	 ...
	 * 
	 */
	public ofstream(org.xbig.base.InstancePointer p) {
		super(p);
	}
	 ...
	 * 
	 */
	protected ofstream(org.xbig.base.InstancePointer p, boolean remote) {
		super(p, remote);
	}
     ...
     */
	public ofstream(org.xbig.base.WithoutNativeObject val) {
		super(val);
	}
	...
	private final native void __delete(long _pointer_);	
          ...
          /** **/
    public ofstream() {
         super( new org.xbig.base.InstancePointer(__createofstream()), false);
    }

    private native static long __createofstream();

    /** **/
    public ofstream(String filename) {
         super( new org.xbig.base.InstancePointer(__createofstream__cP( filename)), false);
    }

    private native static long __createofstream__cP(String filename);
    ...
    public org.std.Iostream flush() {
         return new org.std.ostream(new InstancePointer(_flush(this.object.pointer)));
    }

    private native long _flush(long _pointer_);
    ...
    public org.std.Iostream put(short ch) {
         return new org.std.ostream(new InstancePointer(_put__cv(this.object.pointer, ch)));
    }

    private native long _put__cv(long _pointer_, short ch);
