...
public class TagPoint extends org.xbig.base.NativeObject implements org.ogre4j.ITagPoint {
static { System.loadLibrary("ogre4j");}
	 ...
	 * 
	 */
	public TagPoint(org.xbig.base.InstancePointer p) {
		super(p);
	}
	 ...
	 * 
	 */
	protected TagPoint(org.xbig.base.InstancePointer p, boolean remote) {
		super(p, remote);
	}
     ...
     */
	public TagPoint(org.xbig.base.WithoutNativeObject val) {
		super(val);
	}
	...
	private final native void __delete(long _pointer_);	
          ...
          /** **/
    public TagPoint(int handle, org.ogre4j.ISkeleton creator) {
         super( new org.xbig.base.InstancePointer(__createTagPoint__HvSkeletonp( handle,  creator.getInstancePointer().pointer)), false);
    }

    private native static long __createTagPoint__HvSkeletonp(int handle, long creator);

    /** **/
    public org.ogre4j.IEntity getParentEntity() {
         return new org.ogre4j.Entity(new InstancePointer(_getParentEntity_const(this.object.pointer)));
    }

    private native long _getParentEntity_const(long _pointer_);

    /** **/
    public org.ogre4j.IMovableObject getChildObject() {
         return new org.ogre4j.MovableObject(new InstancePointer(_getChildObject_const(this.object.pointer)));
    }

    private native long _getChildObject_const(long _pointer_);

    /** **/
    public void setParentEntity(org.ogre4j.IEntity pEntity) {
        _setParentEntity__Entityp(this.object.pointer, pEntity.getInstancePointer().pointer);
    }

    private native void _setParentEntity__Entityp(long _pointer_, long pEntity);

    /** **/
    public void setChildObject(org.ogre4j.IMovableObject pObject) {
        _setChildObject__MovableObjectp(this.object.pointer, pObject.getInstancePointer().pointer);
    }

    private native void _setChildObject__MovableObjectp(long _pointer_, long pObject);
    ...
    public void setInheritParentEntityOrientation(boolean inherit) {
        _setInheritParentEntityOrientation__bv(this.object.pointer, inherit);
    }

    private native void _setInheritParentEntityOrientation__bv(long _pointer_, boolean inherit);
    ...
    public boolean getInheritParentEntityOrientation() {
         return _getInheritParentEntityOrientation_const(this.object.pointer);
    }

    private native boolean _getInheritParentEntityOrientation_const(long _pointer_);
    ...
    public void setInheritParentEntityScale(boolean inherit) {
        _setInheritParentEntityScale__bv(this.object.pointer, inherit);
    }

    private native void _setInheritParentEntityScale__bv(long _pointer_, boolean inherit);
    ...
    public boolean getInheritParentEntityScale() {
         return _getInheritParentEntityScale_const(this.object.pointer);
    }

    private native boolean _getInheritParentEntityScale_const(long _pointer_);

    /** 
    Gets the transform of parent entity. **/
    public org.ogre4j.IMatrix4 getParentEntityTransform() {
         return new org.ogre4j.Matrix4(new InstancePointer(_getParentEntityTransform_const(this.object.pointer)));
    }

    private native long _getParentEntityTransform_const(long _pointer_);

    /** 
    Gets the transform of this node just for the skeleton (not entity) **/
    public org.ogre4j.IMatrix4 _getFullLocalTransform() {
         return new org.ogre4j.Matrix4(new InstancePointer(__getFullLocalTransform_const(this.object.pointer)));
    }

    private native long __getFullLocalTransform_const(long _pointer_);
    ...
    **/
    ...
    public void updateFromParentImpl() {
        _updateFromParentImpl_const(this.object.pointer);
    }

    private native void _updateFromParentImpl_const(long _pointer_);
