...
public class RaySceneQuery extends org.xbig.base.NativeObject implements org.ogre4j.IRaySceneQuery {
static { System.loadLibrary("ogre4j");}
	 ...
	 * 
	 */
	public RaySceneQuery(org.xbig.base.InstancePointer p) {
		super(p);
	}
	 ...
	 * 
	 */
	protected RaySceneQuery(org.xbig.base.InstancePointer p, boolean remote) {
		super(p, remote);
	}
     ...
     */
	public RaySceneQuery(org.xbig.base.WithoutNativeObject val) {
		super(val);
	}
    ...
    public void setRay(org.ogre4j.IRay ray) {
        _setRay__RayR(this.object.pointer, ray.getInstancePointer().pointer);
    }

    private native void _setRay__RayR(long _pointer_, long ray);

    /** 
    Gets the ray which is to be used for this query. **/
    public org.ogre4j.IRay getRay() {
         return new org.ogre4j.Ray(new InstancePointer(_getRay_const(this.object.pointer)));
    }

    private native long _getRay_const(long _pointer_);
    ...
    public void setSortByDistance(boolean sort, int maxresults) {
        _setSortByDistance__bvushortv(this.object.pointer, sort,  maxresults);
    }

    private native void _setSortByDistance__bvushortv(long _pointer_, boolean sort, int maxresults);

    /** 
    Gets whether the results are sorted by distance. **/
    public boolean getSortByDistance() {
         return _getSortByDistance_const(this.object.pointer);
    }

    private native boolean _getSortByDistance_const(long _pointer_);

    /** 
    Gets the maximum number of results returned from the query (only relevant if results are being sorted) **/
    public int getMaxResults() {
         return _getMaxResults_const(this.object.pointer);
    }

    private native int _getMaxResults_const(long _pointer_);

    /** 
    Executes the query, returning the results back in one list. **/
    public org.ogre4j.IRaySceneQueryResult execute() {
         return new org.ogre4j.RaySceneQueryResult(new InstancePointer(_execute(this.object.pointer)));
    }
    ...
    public void execute(org.ogre4j.IRaySceneQueryListener listener) {
        _execute__RaySceneQueryListenerp(this.object.pointer, listener.getInstancePointer().pointer);
    }

    private native void _execute__RaySceneQueryListenerp(long _pointer_, long listener);
    ...
    public org.ogre4j.IRaySceneQueryResult getLastResults() {
         return new org.ogre4j.RaySceneQueryResult(new InstancePointer(_getLastResults(this.object.pointer)));
    }

    private native long _getLastResults(long _pointer_);
