...
public class PatchMesh extends org.xbig.base.NativeObject implements org.ogre4j.IPatchMesh {
static { System.loadLibrary("ogre4j");}
	 ...
	 * 
	 */
	public PatchMesh(org.xbig.base.InstancePointer p) {
		super(p);
	}
	 ...
	 * 
	 */
	protected PatchMesh(org.xbig.base.InstancePointer p, boolean remote) {
		super(p, remote);
	}
     ...
     */
	public PatchMesh(org.xbig.base.WithoutNativeObject val) {
		super(val);
	}
	...
	private final native void __delete(long _pointer_);	
          ...
          /** **/
    public PatchMesh(org.ogre4j.IResourceManager creator, String name, long handle, String group) {
         super( new org.xbig.base.InstancePointer(__createPatchMesh__ResourceManagerpStringRResourceHandlevStringR( creator.getInstancePointer().pointer,  name,  handle,  group)), false);
    }

    private native static long __createPatchMesh__ResourceManagerpStringRResourceHandlevStringR(long creator, String name, long handle, String group);
    ...
    public void define(VoidPointer controlPointBuffer, org.ogre4j.IVertexDeclaration declaration, int width, int height, int uMaxSubdivisionLevel, int vMaxSubdivisionLevel, org.ogre4j.PatchSurface.VisibleSide visibleSide, org.ogre4j.HardwareBuffer.Usage vbUsage, org.ogre4j.HardwareBuffer.Usage ibUsage, boolean vbUseShadow, boolean ibUseShadow) {
        _define__vpVertexDeclarationpivivivivPatchSurface_VisibleSidevHardwareBuffer_UsagevHardwareBuffer_Usagevbvbv(this.object.pointer, controlPointBuffer.object.pointer,  declaration.getInstancePointer().pointer,  width,  height,  uMaxSubdivisionLevel,  vMaxSubdivisionLevel,  visibleSide.getValue(),  vbUsage.getValue(),  ibUsage.getValue(),  vbUseShadow,  ibUseShadow);
    }

    private native void _define__vpVertexDeclarationpivivivivPatchSurface_VisibleSidevHardwareBuffer_UsagevHardwareBuffer_Usagevbvbv(long _pointer_, long controlPointBuffer, long declaration, int width, int height, int uMaxSubdivisionLevel, int vMaxSubdivisionLevel, int visibleSide, int vbUsage, int ibUsage, boolean vbUseShadow, boolean ibUseShadow);

    /** **/
    public void setSubdivision(float factor) {
        _setSubdivision__Realv(this.object.pointer, factor);
    }

    private native void _setSubdivision__Realv(long _pointer_, float factor);
