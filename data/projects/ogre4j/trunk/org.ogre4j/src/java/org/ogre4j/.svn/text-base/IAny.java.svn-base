...
public interface IAny extends INativeObject {

public static interface Iholder < ValueType > extends INativeObject, org.ogre4j.IAny.Iplaceholder {


					// interfaces for templates do not get any methods

				}
public static interface Iplaceholder extends INativeObject {
