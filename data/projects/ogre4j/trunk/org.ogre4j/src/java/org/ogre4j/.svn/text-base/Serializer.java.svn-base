...
public class Serializer extends org.xbig.base.NativeObject implements org.ogre4j.ISerializer {
...
static class EndianHelper{
	 ...
	 * 
	 */
	public Serializer(org.xbig.base.InstancePointer p) {
		super(p);
	}
	 ...
	 * 
	 */
	protected Serializer(org.xbig.base.InstancePointer p, boolean remote) {
		super(p, remote);
	}
     ...
     */
	public Serializer(org.xbig.base.WithoutNativeObject val) {
		super(val);
	}
	...
	private final native void __delete(long _pointer_);	
          ...
          /** **/
    public Serializer() {
         super( new org.xbig.base.InstancePointer(__createSerializer()), false);
    }

    private native static long __createSerializer();
