...
public class Rectangle2D extends org.xbig.base.NativeObject implements org.ogre4j.IRectangle2D {
static { System.loadLibrary("ogre4j");}
	 ...
	 * 
	 */
	public Rectangle2D(org.xbig.base.InstancePointer p) {
		super(p);
	}
	 ...
	 * 
	 */
	protected Rectangle2D(org.xbig.base.InstancePointer p, boolean remote) {
		super(p, remote);
	}
     ...
     */
	public Rectangle2D(org.xbig.base.WithoutNativeObject val) {
		super(val);
	}
    ...
    public Rectangle2D(boolean includeTextureCoordinates) {
         super( new org.xbig.base.InstancePointer(__createRectangle2D__bv( includeTextureCoordinates)), false);
    }

    private native static long __createRectangle2D__bv(boolean includeTextureCoordinates);

    /** 
    Sets the corners of the rectangle, in relative coordinates. **/
    public void setCorners(float left, float top, float right, float bottom) {
        _setCorners__RealvRealvRealvRealv(this.object.pointer, left,  top,  right,  bottom);
    }

    private native void _setCorners__RealvRealvRealvRealv(long _pointer_, float left, float top, float right, float bottom);
