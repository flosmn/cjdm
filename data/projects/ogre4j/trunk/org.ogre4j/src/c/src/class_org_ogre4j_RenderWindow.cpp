...
#include "class_org_ogre4j_RenderWindow.h"
...
)
{
  ...
  const Ogre::NameValuePairList* _cpp_miscParams = reinterpret_cast< const Ogre::NameValuePairList* >(miscParams); 
   ...
   Ogre::RenderWindow* _cpp_this = reinterpret_cast<Ogre::RenderWindow*>(_jni_pointer_); 
   
   // call library method 
   _cpp_this->create(_cpp_name, _cpp_width, _cpp_height, _cpp_fullScreen, _cpp_miscParams);
} /* virtual void Ogre::RenderWindow::create */
...
)
{
  ...
  unsigned int _cpp_height = height; 
   ...
   // call library method 
   _cpp_this->setFullscreen(_cpp_fullScreen, _cpp_width, _cpp_height);
} /* virtual void Ogre::RenderWindow::setFullscreen */
...
)
{
   ...
   // call library method 
   _cpp_this->destroy();
} /* virtual void Ogre::RenderWindow::destroy */
...
)
{
  ...
  unsigned int _cpp_height = height; 
   ...
   // call library method 
   _cpp_this->resize(_cpp_width, _cpp_height);
} /* virtual void Ogre::RenderWindow::resize */
...
)
{
   ...
   // call library method 
   _cpp_this->windowMovedOrResized();
...
)
{
  ...
  int _cpp_top = top; 
   ...
   // call library method 
   _cpp_this->reposition(_cpp_left, _cpp_top);
} /* virtual void Ogre::RenderWindow::reposition */
...
)
{
   ...
   // cast pointer to C++ object 
   const Ogre::RenderWindow* _cpp_this = reinterpret_cast<const Ogre::RenderWindow*>(_jni_pointer_); 
   
   // call library method 
   const bool _cpp_result = _cpp_this->isVisible() ; 
   return _cpp_result ? 1 : 0;
} /* virtual bool Ogre::RenderWindow::isVisible */
...
} /* virtual void Ogre::RenderWindow::setVisible */
...
)
{
   ...
   return _cpp_result ? 1 : 0;
} /* virtual bool Ogre::RenderWindow::isActive */
...
)
{
   ...
   return _cpp_result ? 1 : 0;
} /* virtual bool Ogre::RenderWindow::isClosed */
...
)
{
   ...
   return _cpp_result ? 1 : 0;
} /* virtual bool Ogre::RenderWindow::isPrimary */
...
)
{
   ...
   // call library method 
   const bool _cpp_result = _cpp_this->isFullScreen() ; 
   return _cpp_result ? 1 : 0;
} /* virtual bool Ogre::RenderWindow::isFullScreen */
...
)
{
  ...
  int* _cpp_top = reinterpret_cast<int*>(top); 
   ...
   // call library method 
   _cpp_this->getMetrics(*_cpp_width, *_cpp_height, *_cpp_colourDepth, *_cpp_left, *_cpp_top);
} /* virtual void Ogre::RenderWindow::getMetrics */
...
)
{
   ...
   return _cpp_result;
} /* PixelFormat Ogre::RenderWindow::suggestPixelFormat */
...
)
{
   ...
   // call library method 
   const bool _cpp_result = _cpp_this->isDeactivatedOnFocusChange() ; 
   return _cpp_result ? 1 : 0;
} /* bool Ogre::RenderWindow::isDeactivatedOnFocusChange */
...
{
   // parameter conversions 
  bool _cpp_deactivate = deactivate ? true : false; 
   
   // cast pointer to C++ object 
   Ogre::RenderWindow* _cpp_this = reinterpret_cast<Ogre::RenderWindow*>(_jni_pointer_); 
   
   // call library method 
   _cpp_this->setDeactivateOnFocusChange(_cpp_deactivate);
} /* void Ogre::RenderWindow::setDeactivateOnFocusChange */
...
)
{
  ...
  unsigned int* _cpp_colourDepth = reinterpret_cast<unsigned int*>(colourDepth); 
   ...
   // call library method 
   _cpp_this->Ogre::RenderTarget::getMetrics(*_cpp_width, *_cpp_height, *_cpp_colourDepth);
...
{
   // destructor of class Ogre::RenderWindow 
   // cast pointer to C++ object 
   Ogre::RenderWindow* _cpp_this = reinterpret_cast<Ogre::RenderWindow*>(_jni_pointer_); 
   // delete object if it exists 
   if(_cpp_this != NULL) delete _cpp_this;
} /* Ogre::RenderWindow::__delete */
