...
#include "class_org_ogre4j_SceneManager_00024MovableObjectIterator.h"
...
)
{
   ...
   const Ogre::SceneManager::MovableObjectIterator* _cpp_this = reinterpret_cast<const Ogre::SceneManager::MovableObjectIterator*>(_jni_pointer_); 
...
)
{
   ...
   // cast pointer to C++ object 
   Ogre::SceneManager::MovableObjectIterator* _cpp_this = reinterpret_cast<Ogre::SceneManager::MovableObjectIterator*>(_jni_pointer_); 
...
{
   // parameter conversions 
  Ogre::SceneManager::MovableObjectIterator* _cpp_rhs = reinterpret_cast< Ogre::SceneManager::MovableObjectIterator* >(rhs); 
   
   // cast pointer to C++ object 
   Ogre::SceneManager::MovableObjectIterator* _cpp_this = reinterpret_cast<Ogre::SceneManager::MovableObjectIterator*>(_jni_pointer_); 
   
   // call library method 
   const Ogre::SceneManager::MovableObjectIterator* _cpp_result = & _cpp_this->operator=(*_cpp_rhs) ; 
   return reinterpret_cast<jlong>(_cpp_result);
...
{
   // destructor of class Ogre::SceneManager::MovableObjectIterator 
   // cast pointer to C++ object 
   Ogre::SceneManager::MovableObjectIterator* _cpp_this = reinterpret_cast<Ogre::SceneManager::MovableObjectIterator*>(_jni_pointer_); 
   // delete object if it exists 
   if(_cpp_this != NULL) delete _cpp_this;
} /* Ogre::SceneManager::MovableObjectIterator::__delete */
