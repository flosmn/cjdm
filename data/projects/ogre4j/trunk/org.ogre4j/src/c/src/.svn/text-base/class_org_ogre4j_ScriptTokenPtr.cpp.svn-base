...
#include "class_org_ogre4j_ScriptTokenPtr.h"
...
{
   // constructor of class Ogre::ScriptTokenPtr 
   
   // parameter conversions 
   
   // create new instance of class Ogre::ScriptTokenPtr 
   Ogre::ScriptTokenPtr* _cpp_this = new Ogre::ScriptTokenPtr(); 
...
{
   // parameter conversions 
  const Ogre::ScriptTokenPtr* _cpp_r = reinterpret_cast< const Ogre::ScriptTokenPtr* >(r); 
   
   // cast pointer to C++ object 
   Ogre::ScriptTokenPtr* _cpp_this = reinterpret_cast<Ogre::ScriptTokenPtr*>(_jni_pointer_); 
   
   // call library method 
   const Ogre::ScriptTokenPtr* _cpp_result = & _cpp_this->operator=(*_cpp_r) ; 
...
)
{
   ...
   // cast pointer to C++ object 
   const Ogre::ScriptTokenPtr* _cpp_this = reinterpret_cast<const Ogre::ScriptTokenPtr*>(_jni_pointer_); 
   
   // call library method 
   const Ogre::ScriptToken* _cpp_result = & _cpp_this->operator *() ; 
   return reinterpret_cast<jlong>(_cpp_result);
...
)
{
   ...
   // call library method 
   const Ogre::ScriptToken* _cpp_result = _cpp_this->get() ; 
   return reinterpret_cast<jlong>(_cpp_result);
...
{
   // parameter conversions 
  Ogre::ScriptToken* _cpp_rep = reinterpret_cast< Ogre::ScriptToken* >(rep);
...
)
{
   ...
   // call library method 
   const Ogre::ScriptToken* _cpp_result = _cpp_this->getPointer() ; 
   return reinterpret_cast<jlong>(_cpp_result);
...
{
   // destructor of class Ogre::ScriptTokenPtr 
   // cast pointer to C++ object 
   Ogre::ScriptTokenPtr* _cpp_this = reinterpret_cast<Ogre::ScriptTokenPtr*>(_jni_pointer_); 
   // delete object if it exists 
   if(_cpp_this != NULL) delete _cpp_this;
} /* Ogre::ScriptTokenPtr::__delete */
