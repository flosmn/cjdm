...
#include "class_org_ogre4j_SceneQueryMovableObjectPair.h"
...
{
   // destructor of class Ogre::SceneQueryMovableObjectPair 
   // cast pointer to C++ object 
   Ogre::SceneQueryMovableObjectPair* _cpp_this = reinterpret_cast<Ogre::SceneQueryMovableObjectPair*>(_jni_pointer_); 
   // delete object if it exists 
   if(_cpp_this != NULL) delete _cpp_this;
} /* Ogre::SceneQueryMovableObjectPair::__delete */
...
)
{
   ...
   // call library method 
   const Ogre::MovableObject* _cpp_result = _cpp_this->second; 
   return reinterpret_cast<jlong>(_cpp_result);
} /* S std::pair::second */
