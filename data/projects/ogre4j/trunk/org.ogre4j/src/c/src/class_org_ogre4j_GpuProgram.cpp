...
#include "class_org_ogre4j_GpuProgram.h"
...
)
{
  ...
  std::string _cpp_filename = ""; org::xbig::jni::to_stdstring(_jni_env_, filename, _cpp_filename); // calls c-tor only. Not operator= .; 
   ...
   Ogre::GpuProgram* _cpp_this = reinterpret_cast<Ogre::GpuProgram*>(_jni_pointer_); 
...
)
{
   ...
   // cast pointer to C++ object 
   const Ogre::GpuProgram* _cpp_this = reinterpret_cast<const Ogre::GpuProgram*>(_jni_pointer_); 
...
)
{
   ...
   return reinterpret_cast<jlong>(_cpp_result);
} /* virtual const GpuNamedConstants& Ogre::GpuProgram::getNamedConstants */
...
)
{
   ...
   return reinterpret_cast<jlong>(_cpp_result);
} /* virtual const GpuNamedConstants& Ogre::GpuProgram::getConstantDefinitions */
...
{
   // static method of class Ogre::GpuProgram without return value 
   // parameter conversions 
   
   // call library method 
   Ogre::GpuProgram::cleanupDictionary();
...
{
   // destructor of class Ogre::GpuProgram 
   // cast pointer to C++ object 
   Ogre::GpuProgram* _cpp_this = reinterpret_cast<Ogre::GpuProgram*>(_jni_pointer_); 
   // delete object if it exists 
   if(_cpp_this != NULL) delete _cpp_this;
} /* Ogre::GpuProgram::__delete */
