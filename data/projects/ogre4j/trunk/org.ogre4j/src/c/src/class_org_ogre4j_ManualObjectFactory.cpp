...
#include "class_org_ogre4j_ManualObjectFactory.h"
...
{
   // constructor of class Ogre::ManualObjectFactory 
   
   // parameter conversions 
   
   // create new instance of class Ogre::ManualObjectFactory 
   Ogre::ManualObjectFactory* _cpp_this = new Ogre::ManualObjectFactory(); 
...
)
{
   ...
   const Ogre::ManualObjectFactory* _cpp_this = reinterpret_cast<const Ogre::ManualObjectFactory*>(_jni_pointer_); 
...
)
{
  ...
  Ogre::MovableObject* _cpp_obj = reinterpret_cast< Ogre::MovableObject* >(obj); 
   ...
   // cast pointer to C++ object 
   Ogre::ManualObjectFactory* _cpp_this = reinterpret_cast<Ogre::ManualObjectFactory*>(_jni_pointer_); 
...
{
   // destructor of class Ogre::ManualObjectFactory 
   // cast pointer to C++ object 
   Ogre::ManualObjectFactory* _cpp_this = reinterpret_cast<Ogre::ManualObjectFactory*>(_jni_pointer_); 
   // delete object if it exists 
   if(_cpp_this != NULL) delete _cpp_this;
} /* Ogre::ManualObjectFactory::__delete */
...
)
{
   ...
   // call library method 
   const std::string _cpp_result = Ogre::ManualObjectFactory::FACTORY_TYPE_NAME ; 
   return org::xbig::jni::to_jstring(_jni_env_, _cpp_result);
...
)
{
  ...
  std::string _cpp__jni_value_ = ""; org::xbig::jni::to_stdstring(_jni_env_, _jni_value_, _cpp__jni_value_); // calls c-tor only. Not operator= .; 
   ...
   // call library method 
   Ogre::ManualObjectFactory::FACTORY_TYPE_NAME = _cpp__jni_value_;
} /* String Ogre::ManualObjectFactory::FACTORY_TYPE_NAME */
