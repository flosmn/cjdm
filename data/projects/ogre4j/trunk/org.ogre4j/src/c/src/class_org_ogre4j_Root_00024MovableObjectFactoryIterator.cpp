...
#include "class_org_ogre4j_Root_00024MovableObjectFactoryIterator.h"
...
)
{
   ...
   const Ogre::Root::MovableObjectFactoryIterator* _cpp_this = reinterpret_cast<const Ogre::Root::MovableObjectFactoryIterator*>(_jni_pointer_); 
...
)
{
   ...
   // cast pointer to C++ object 
   Ogre::Root::MovableObjectFactoryIterator* _cpp_this = reinterpret_cast<Ogre::Root::MovableObjectFactoryIterator*>(_jni_pointer_); 
   
   // call library method 
   const Ogre::MovableObjectFactory* _cpp_result = _cpp_this->getNext() ; 
...
)
{
   ...
   // call library method 
   const Ogre::MovableObjectFactory* _cpp_result = _cpp_this->peekNextValue() ; 
   return reinterpret_cast<jlong>(_cpp_result);
...
{
   // parameter conversions 
  Ogre::Root::MovableObjectFactoryIterator* _cpp_rhs = reinterpret_cast< Ogre::Root::MovableObjectFactoryIterator* >(rhs); 
   
   // cast pointer to C++ object 
   Ogre::Root::MovableObjectFactoryIterator* _cpp_this = reinterpret_cast<Ogre::Root::MovableObjectFactoryIterator*>(_jni_pointer_); 
   
   // call library method 
   const Ogre::Root::MovableObjectFactoryIterator* _cpp_result = & _cpp_this->operator=(*_cpp_rhs) ; 
   return reinterpret_cast<jlong>(_cpp_result);
...
)
{
   ...
   // call library method 
   const Ogre::MovableObjectFactory*const * _cpp_result = _cpp_this->peekNextValuePtr() ; 
   return reinterpret_cast<jlong>(_cpp_result);
...
{
   // destructor of class Ogre::Root::MovableObjectFactoryIterator 
   // cast pointer to C++ object 
   Ogre::Root::MovableObjectFactoryIterator* _cpp_this = reinterpret_cast<Ogre::Root::MovableObjectFactoryIterator*>(_jni_pointer_); 
   // delete object if it exists 
   if(_cpp_this != NULL) delete _cpp_this;
} /* Ogre::Root::MovableObjectFactoryIterator::__delete */
