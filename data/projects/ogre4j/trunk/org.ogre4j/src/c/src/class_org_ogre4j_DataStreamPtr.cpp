...
#include "class_org_ogre4j_DataStreamPtr.h"
...
{
   // constructor of class Ogre::DataStreamPtr 
   
   // parameter conversions 
   
   // create new instance of class Ogre::DataStreamPtr 
   Ogre::DataStreamPtr* _cpp_this = new Ogre::DataStreamPtr(); 
...
{
   // parameter conversions 
  const Ogre::DataStreamPtr* _cpp_r = reinterpret_cast< const Ogre::DataStreamPtr* >(r); 
   
   // cast pointer to C++ object 
   Ogre::DataStreamPtr* _cpp_this = reinterpret_cast<Ogre::DataStreamPtr*>(_jni_pointer_); 
   
   // call library method 
   const Ogre::DataStreamPtr* _cpp_result = & _cpp_this->operator=(*_cpp_r) ; 
...
)
{
   ...
   // cast pointer to C++ object 
   const Ogre::DataStreamPtr* _cpp_this = reinterpret_cast<const Ogre::DataStreamPtr*>(_jni_pointer_); 
   
   // call library method 
   const Ogre::DataStream* _cpp_result = & _cpp_this->operator *() ; 
   return reinterpret_cast<jlong>(_cpp_result);
...
)
{
   ...
   // call library method 
   const Ogre::DataStream* _cpp_result = _cpp_this->get() ; 
   return reinterpret_cast<jlong>(_cpp_result);
...
{
   // parameter conversions 
  Ogre::DataStream* _cpp_rep = reinterpret_cast< Ogre::DataStream* >(rep);
...
)
{
   ...
   // call library method 
   const Ogre::DataStream* _cpp_result = _cpp_this->getPointer() ; 
   return reinterpret_cast<jlong>(_cpp_result);
...
{
   // destructor of class Ogre::DataStreamPtr 
   // cast pointer to C++ object 
   Ogre::DataStreamPtr* _cpp_this = reinterpret_cast<Ogre::DataStreamPtr*>(_jni_pointer_); 
   // delete object if it exists 
   if(_cpp_this != NULL) delete _cpp_this;
} /* Ogre::DataStreamPtr::__delete */
