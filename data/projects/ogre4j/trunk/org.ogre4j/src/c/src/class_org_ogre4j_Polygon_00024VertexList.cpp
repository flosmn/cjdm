...
#include "class_org_ogre4j_Polygon_00024VertexList.h"
...
{
   // constructor of class Ogre::Polygon::VertexList 
   
   // parameter conversions 
   
   // create new instance of class Ogre::Polygon::VertexList 
   Ogre::Polygon::VertexList* _cpp_this = new Ogre::Polygon::VertexList(); 
...
)
{
   // parameter conversions 
  size_t _cpp_num = num;
  const Ogre::Vector3* _cpp_val = reinterpret_cast< Ogre::Vector3* const >(val); 
   
   // cast pointer to C++ object 
   Ogre::Polygon::VertexList* _cpp_this = reinterpret_cast<Ogre::Polygon::VertexList*>(_jni_pointer_); 
...
)
{
  ...
  size_t _cpp_loc = loc; 
   ...
   // call library method 
   const Ogre::Vector3* _cpp_result = & _cpp_this->at(_cpp_loc) ; 
...
)
{
   ...
   // call library method 
   const Ogre::Vector3* _cpp_result = & _cpp_this->back() ; 
   return reinterpret_cast<jlong>(_cpp_result);
} /* T std::vector::back */
...
)
{
   ...
   // call library method 
   const Ogre::Vector3* _cpp_result = & _cpp_this->front() ; 
   return reinterpret_cast<jlong>(_cpp_result);
} /* T std::vector::front */
...
{
   // destructor of class Ogre::Polygon::VertexList 
   // cast pointer to C++ object 
   Ogre::Polygon::VertexList* _cpp_this = reinterpret_cast<Ogre::Polygon::VertexList*>(_jni_pointer_); 
   // delete object if it exists 
   if(_cpp_this != NULL) delete _cpp_this;
} /* Ogre::Polygon::VertexList::__delete */
