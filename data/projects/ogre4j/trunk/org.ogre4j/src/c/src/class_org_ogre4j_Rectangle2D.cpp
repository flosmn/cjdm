...
#include "class_org_ogre4j_Rectangle2D.h"
...
{
   // constructor of class Ogre::Rectangle2D 
   
   // parameter conversions 
  bool _cpp_includeTextureCoordinates = includeTextureCoordinates ? true : false; 
   
   // create new instance of class Ogre::Rectangle2D 
   Ogre::Rectangle2D* _cpp_this = new Ogre::Rectangle2D(_cpp_includeTextureCoordinates); 
...
)
{
  ...
  float _cpp_bottom = bottom; 
   ...
   Ogre::Rectangle2D* _cpp_this = reinterpret_cast<Ogre::Rectangle2D*>(_jni_pointer_); 
   
   // call library method 
   _cpp_this->setCorners(_cpp_left, _cpp_top, _cpp_right, _cpp_bottom);
} /* void Ogre::Rectangle2D::setCorners */
...
)
{
  ...
  const Ogre::Camera* _cpp_cam = reinterpret_cast< const Ogre::Camera* >(cam); 
   ...
   // cast pointer to C++ object 
   const Ogre::Rectangle2D* _cpp_this = reinterpret_cast<const Ogre::Rectangle2D*>(_jni_pointer_); 
   
   // call library method 
   const float _cpp_result = _cpp_this->getSquaredViewDepth(_cpp_cam) ; 
   return _cpp_result;
} /* Real Ogre::Rectangle2D::getSquaredViewDepth */
...
)
{
   ...
   return _cpp_result;
} /* Real Ogre::Rectangle2D::getBoundingRadius */
...
{
   // static method of class Ogre::Rectangle2D without return value 
   // parameter conversions 
  unsigned int _cpp_flags = flags; 
   
   // call library method 
   Ogre::Rectangle2D::setDefaultQueryFlags(_cpp_flags);
...
{
   // static method of class Ogre::Rectangle2D with return value 
   // parameter conversions 
   
   // call library method 
   const unsigned int _cpp_result = Ogre::Rectangle2D::getDefaultQueryFlags(); 
   return _cpp_result;
...
)
{
  ...
  unsigned int _cpp_flags = flags; 
   ...
   // call library method 
   Ogre::Rectangle2D::setDefaultVisibilityFlags(_cpp_flags);
...
)
{
   ...
   // call library method 
   const unsigned int _cpp_result = Ogre::Rectangle2D::getDefaultVisibilityFlags(); 
   return _cpp_result;
...
)
{
  ...
  float _cpp_extrudeDist = extrudeDist; 
   ...
   // call library method 
   Ogre::Rectangle2D::extrudeVertices(*_cpp_vertexBuffer, _cpp_originalVertexCount, *_cpp_lightPos, _cpp_extrudeDist);
...
{
   // destructor of class Ogre::Rectangle2D 
   // cast pointer to C++ object 
   Ogre::Rectangle2D* _cpp_this = reinterpret_cast<Ogre::Rectangle2D*>(_jni_pointer_); 
   // delete object if it exists 
   if(_cpp_this != NULL) delete _cpp_this;
} /* Ogre::Rectangle2D::__delete */
