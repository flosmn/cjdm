...
#include "class_org_ogre4j_IOException.h"
...
{
   // constructor of class Ogre::IOException 
  ...
  long _cpp_line = line; 
   ...
   // create new instance of class Ogre::IOException 
   Ogre::IOException* _cpp_this = new Ogre::IOException(_cpp_number, _cpp_description, _cpp_source, _cpp_file, _cpp_line); 
...
{
   // parameter conversions 
  const Ogre::IOException* _cpp_rhs = reinterpret_cast< const Ogre::IOException* >(rhs); 
   
   // cast pointer to C++ object 
   Ogre::IOException* _cpp_this = reinterpret_cast<Ogre::IOException*>(_jni_pointer_); 
...
)
{
   ...
   // cast pointer to C++ object 
   const Ogre::IOException* _cpp_this = reinterpret_cast<const Ogre::IOException*>(_jni_pointer_); 
...
{
   // destructor of class Ogre::IOException 
   // cast pointer to C++ object 
   Ogre::IOException* _cpp_this = reinterpret_cast<Ogre::IOException*>(_jni_pointer_); 
   // delete object if it exists 
   if(_cpp_this != NULL) delete _cpp_this;
} /* Ogre::IOException::__delete */
