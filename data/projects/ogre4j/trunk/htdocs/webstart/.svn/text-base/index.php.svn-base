				...
				<div class="content">
					<div class="content_inner">
						...
						<div class="content_head">
							<h2><a name="project">ogre4j Webstart Examples</a></h2>
						</div>
						<div class="content_main">
							
                                                        <h3>1. Prerequisites</h3>
                                                        <p><br/>To run this example applications through Java Webstart you need the JRE
                                                        with version 1.5.</p>
                                                        <p><b>Note:</b> At the moment there are binaries included for Windows
                                                        only. Please stay tuned for future OS support and more webstart examples.</p>
                                                        <p><b>Note:</b> If you use Java 6 you have to wait a little until the window apears.
                                                        That is because cache handling has changed in Java 6.</p>
                                                        
                                                        <h3>2. SWT Examples</h3>
                                                        <p><br/>HelloWorld : <a href="org.ogre4j.examples.swt.helloworld-d3d9.jnlp">D3D9</a> | <a href="org.ogre4j.examples.swt.helloworld-gl.jnlp">OpenGL</a><br />
                                                        A simple HelloWorld example that loads a cake mesh that is placed on a
                                                        plane. The plane is generated during runtime.<br/>Use W, A, S, D, C, SPACE
                                                        to move around. Hold left mouse button to look around.<br/>If you want to know how the 
                                                        code looks like, take a look at 
                                                        <a href="http://ogre4j.svn.sourceforge.net/viewvc/ogre4j/trunk/org.ogre4j.examples.swt/src/org/ogre4j/examples/swt/HelloWorld.java?revision=288&amp;view=markup">
                                                        HelloWorld.java</a>.</p>
