...
import org.ogre4j.eclipse.ogreface.viewer.IOgreEntityProvider;

public class VerySimpleEntityProvider implements IOgreEntityProvider {

	public boolean getAutoUpdateAnimation(Object element) {
		return false;
	}

	public boolean getLoopAnimation(Object element) {
		return false;
	}

	public String getMesh(Object element) {
		if (element instanceof VerySimpleDomainObject) {
			VerySimpleDomainObject domObj = (VerySimpleDomainObject) element;
			if (domObj.getType().equals(VerySimpleDomainObject.Type.ENTITY))
				return domObj.getMesh();
		}
		return null;
	}

	public String getPlayAnimation(Object element) {
		return null;
	}
	...
	public boolean isStatic(Object element) {
		return false;
	}
