...
public class RenderLoopAlways implements IRenderLoop {

    private Vector<IFrameListener> frameListeners = new Vector<IFrameListener>();

    private Timer timer = new Timer();

    private long period = 60000 / 30;
    ...
    public void redraw() {
        // ignored, because of always rendering
    }
    ...
    private void fireFrameStarted() {
        // TODO calc time
        float timeSinceLastEvent = (float) (period * 1000);
