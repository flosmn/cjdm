 ...
 * 
 */
public class OgrePropertyChangeListener implements IPropertyChangeListener {

    /**
     * 
     */
    public OgrePropertyChangeListener() {
        super();
    }
    ...
    public void propertyChange(PropertyChangeEvent event) {
        OgrePlugin.getDefault().savePluginPreferences();
    }
}
