...
public interface IOgreNodeListener {
     ...
     * @return void
     */
    public void positionChanged(String name, javax.vecmath.Vector3f position);
     ...
     * @return void
     */
    public void orientationChanged(String name, javax.vecmath.Quat4f orientation);
     ...
     * @return void
     */
    public void scaleChanged(String name, javax.vecmath.Vector3f scale);
